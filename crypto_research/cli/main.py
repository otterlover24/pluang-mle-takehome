...
from ..graph.overall_graph import TradingAgentsGraph
from ..research_configs import CRYPTO_CONFIG
...
app = typer.Typer(
    name="CryptoAgents",
    help="CryptoAgents CLI: Multi-Agents LLM Cryptocurrency Trading Framework",
...
class MessageBuffer:
    def __init__(self, max_length=100):
        ...
        self.agent_status = {
            # Crypto Analyst Team
            "Crypto Market Analyst": "pending",
            "Crypto Social Analyst": "pending",
            "Crypto News Analyst": "pending",
            "Crypto Fundamentals Analyst": "pending",
            # Research Team
    ...
    def _update_final_report(self):
        ...
        if any(
            ...
            if self.report_sections["market_report"]:
                report_parts.append(
                    f"### Crypto Market Analysis\n{self.report_sections['market_report']}"
                )
            if self.report_sections["sentiment_report"]:
                report_parts.append(
                    f"### Crypto Social Sentiment\n{self.report_sections['sentiment_report']}"
                )
            if self.report_sections["news_report"]:
                report_parts.append(
                    f"### Crypto News Analysis\n{self.report_sections['news_report']}"
                )
            if self.report_sections["fundamentals_report"]:
                report_parts.append(
                    f"### Crypto Fundamentals Analysis\n{self.report_sections['fundamentals_report']}"
                )
...
def update_display(layout, spinner_text=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to CryptoAgents CLI[/bold green]\n"
...
def get_user_selections():
    ...
    welcome_file = cli_dir / "static" / "welcome.txt"
    ...
    if final_state.get("fundamentals_report"):
        analyst_reports.append(
            Panel(
                ...
                title="Crypto Fundamentals Analyst",
                border_style="blue",
                padding=(1, 2),
            )
        )
            ...
            if len(chunk["messages"]) > 0:
                ...
                if "market_report" in chunk and chunk["market_report"]:
                    ...
                    if "social" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Crypto Social Analyst", "in_progress"
                        )
                ...
                if "sentiment_report" in chunk and chunk["sentiment_report"]:
                    ...
                    if "news" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Crypto News Analyst", "in_progress"
                        )
                ...
                if "news_report" in chunk and chunk["news_report"]:
                    ...
                    if "fundamentals" in selections["analysts"]:
                        message_buffer.update_agent_status(
                            "Crypto Fundamentals Analyst", "in_progress"
                        )
                ...
                if "fundamentals_report" in chunk and chunk["fundamentals_report"]:
                    ...
                    message_buffer.update_agent_status(
                        "Crypto Fundamentals Analyst", "completed"
                    )
...
@app.callback()
def main():
    """CryptoAgents CLI: Multi-Agents LLM Cryptocurrency Trading Framework"""
    pass
